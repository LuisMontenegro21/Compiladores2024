...
class MiniLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MiniLangParser#funcDef.
    def enterFuncDef(self, ctx:MiniLangParser.FuncDefContext):
        pass

    # Exit a parse tree produced by MiniLangParser#funcDef.
    def exitFuncDef(self, ctx:MiniLangParser.FuncDefContext):
        pass
